...
text=[]
label=[]
for q,r,h in zip(train['question'],train['relation'],train['hop']):
    if int(h)==1:
        text.append(q)
        label.append(redict[r])
    else:
        chain=r.split('|')
        text.append(q)
...
text=[]
label=[]
for q,r,h in zip(valid['question'],valid['relation'],valid['hop']):
    if int(h)==1:
        text.append(q)
        label.append(redict[r])
    else:
...
text=[]
label=[]
for q,r,h in zip(test['question'],test['relation'],test['hop']):
    if int(h)==1:
        text.append(q)
        label.append(redict[r])
    else:
