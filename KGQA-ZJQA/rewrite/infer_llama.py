...
base_model = "../../pretrain/chinese-alpaca-2-13b-hf"
lora_model='../../finetune-llama/output-ZJQA/alpaca-13b/best_model'
data='../retrieve/path_prediction/result/test.txt'  
output='output/chinese-alpaca-2-13b.txt'

template='请将下列三元组转化为一句或多句话：{graph}。'
    ...
    with open(data,'r',encoding='utf-8') as f:
        for index,line in tqdm(enumerate(f.readlines())):
            ...
            for i in graph:
                ...
                output = tokenizer.decode(s,skip_special_tokens=True).split(prompt)[-1]
